...
{
    ros::init(argc,argv,"nodecbk");
    ros::NodeHandle n;
    std::string subscribe_topic_="imu/data";
    n.param("subscribe_topic",subscribe_topic_,std::string("imu/data"));
    ros::Subscriber sub=n.subscribe(subscribe_topic_,1,imudataCallback);
    ros::spin();
    return 0;
}
